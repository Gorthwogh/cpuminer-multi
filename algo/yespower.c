...
int yespower_hash(const char *input, char *output, uint32_t len, int thrid, int version)
{
	...
	if (version == 1)
	{
		...
		yespower_tls((yespower_binary_t*)input, len, &v1, (yespower_binary_t*)output, thrid);
	}
	if (version == 2)
	{
		static const yespower_params_t v2 = { YESPOWER_1_0, 4096, 16, NULL, 0 };
		yespower_tls((yespower_binary_t*)input, len, &v2, (yespower_binary_t*)output, thrid);
	}
	if (version == 3)
	{
		...
		yespower_tls((yespower_binary_t*)input, len, &v3, (yespower_binary_t*)output, thrid);
	}
	if (version == 4)
	{
		static const yespower_params_t v4 = { YESPOWER_1_0, 2048, 32, (const uint8_t *)"UraniumX", 8 };
		yespower_tls((yespower_binary_t*)input, len, &v4, (yespower_binary_t*)output, thrid);
	}
	if (version == 5)
	{
		...
		yespower_tls((yespower_binary_t*)input, len, &v5, (yespower_binary_t*)output, thrid);
	}
	if (version == 6)
	{
		static const yespower_params_t v6 = { YESPOWER_1_0, 2048, 32, "InterITC", 8 };
		yespower_tls((yespower_binary_t*)input, len, &v6, (yespower_binary_t*)output, thrid);
	}
	if (version == 7)
	{
		...
		return yespower_tls((yespower_binary_t*)input, len, &v7, (yespower_binary_t*)output, thrid);
	}
